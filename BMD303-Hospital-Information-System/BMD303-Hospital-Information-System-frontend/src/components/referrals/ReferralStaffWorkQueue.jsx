          ...
          <Table>
            ...
            <tbody>
              {referrals.map((referral) => {
                ...
                const invoice = referralInvoices.get(String(id));
                const paymentStatus = invoice ? invoice.status : 'Not Invoiced';
                          ...
                          <>
                            {isPhysioDept ? (
                              <Button
                                ...
                                variant="primary"
                                size="small"
                                onClick={() => setBookingReferral(referral)}
                                disabled={!hasStaffRole}
                                title={!hasStaffRole ? `Requires ${requiredRole} login` : ''}
                              >
                                Book appointment
                              </Button>
                            ) : (
