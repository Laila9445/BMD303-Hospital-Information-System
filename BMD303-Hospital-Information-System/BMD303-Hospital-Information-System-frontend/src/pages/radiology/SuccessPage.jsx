...
export default function SuccessPage() {
    ...
    useEffect(() => {
        ...
        const existing = JSON.parse(localStorage.getItem("radiologyAppointments") || "[]");
        localStorage.setItem("radiologyAppointments", JSON.stringify([...existing, appointment]));
        window.dispatchEvent(new Event("radiology-appointments-updated"));
    }, [data]);
