        ...
        <div className="svc-card">
            ...
            <div className="svc-card-body">
                ...
                <button
                    ...
                    onClick={() => navigate(`/physio/booking?service=${serviceId}`)}
                >
                    Book Now
                </button>
            </div>
...
// Map physio service IDs to billing service names for price lookup
const serviceIdToBillingName = {
    orthopedic: 'Physiotherapy Session',
    'post-surgical': 'Rehabilitation Program',
    'sports-injury': 'Physiotherapy Session',
    'back-neck-pain': 'Physiotherapy Session',
    osteoarthritis: 'Physiotherapy Session',
    'manual-therapy': 'Physiotherapy Session',
    electrotherapy: 'Physiotherapy Session',
};
...
export default function ServicesPage() {
    ...
    // Build price lookup map from billing services for physiotherapy department
