        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PatientId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ExternalPatientId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FullName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ExternalIdSyncedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReferralId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PatientExternalId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    DoctorId = table.Column<int>(type: "int", nullable: false),
                    ...
                    ExternalReferralId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ExternalServiceUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DoctorNotes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExternalServiceFeedback = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ...
                    ExternalSyncAttempts = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ImagingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PatientExternalId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    ExternalImagingId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    StorageUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    DicomReference = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    RadiologyReport = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalImaging", x => x.ImagingId);
                    table.ForeignKey(
                        name: "FK_MedicalImaging_Referrals_ReferralId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TherapyType = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    PlannedSessions = table.Column<int>(type: "int", nullable: false),
                    CompletedSessions = table.Column<int>(type: "int", nullable: false),
                    RecommendedFrequency = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ExpectedDuration = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    TherapyGoals = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    Precautions = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    EquipmentNeeded = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PlannedEndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ActualEndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    AssignedTherapist = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    TherapyFacility = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Outcomes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    FinalAssessment = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    GoalsAchieved = table.Column<bool>(type: "bit", nullable: true),
                    AdherenceScore = table.Column<int>(type: "int", nullable: true),
                    OutcomeScore = table.Column<int>(type: "int", nullable: true),
                    FollowUpNotes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    ExternalPlanId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TherapyPlans", x => x.PlanId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientExternalId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    TimeSlotId = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TherapistName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    PainScoreBefore = table.Column<int>(type: "int", nullable: false),
                    PainScoreAfter = table.Column<int>(type: "int", nullable: false),
                    FunctionalAssessmentBefore = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    FunctionalAssessmentAfter = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ...
                    HomeExercises = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    ExerciseFrequency = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ...
                    TherapyPlanId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ImageId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PatientId = table.Column<int>(type: "int", nullable: true),
                    PatientExternalId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    ExternalRadiologyId = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalImaging_ReferralId",
                table: "MedicalImaging",
                column: "ReferralId");
