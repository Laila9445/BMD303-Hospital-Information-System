...
public class MappingProfile : Profile
{
    public MappingProfile()
    {
        ...
        //     .ForMember(dest => dest.LastName, opt => opt.MapFrom(src => src.FullName.Contains(" ") ? src.FullName.Split(' ')[1] : ""))
        //     .ForMember(dest => dest.Email, opt => opt.MapFrom(src => src.ExternalPatientId))
        //     .ForMember(dest => dest.PhoneNumber, opt => opt.MapFrom(src => src.PhoneNumber));
        
        // UpdatePatientProfileDto mapping commented out - DTO not found
        ...
        // MedicalRecord mappings - Temporarily disabled due to missing DTOs
        // TODO: Fix MedicalHistoryDTO and UpdateMedicalHistoryDto references
        ...
        // Nurse mappings
        CreateMap<NurseModel, NurseProfileDTO>()
            .ForMember(dest => dest.FirstName, opt => opt.MapFrom(src => src.User != null ? src.User.FirstName : string.Empty))
            .ForMember(dest => dest.LastName, opt => opt.MapFrom(src => src.User != null ? src.User.LastName : string.Empty))
            .ForMember(dest => dest.Email, opt => opt.MapFrom(src => src.User != null ? src.User.Email : string.Empty))
            .ForMember(dest => dest.PhoneNumber, opt => opt.MapFrom(src => src.User != null ? src.User.PhoneNumber : string.Empty));

        CreateMap<UpdateNurseProfileRequest, NurseModel>();

        // PatientCareTask mappings
        CreateMap<PatientCareTaskModel, PatientCareTaskDTO>();
        CreateMap<CreatePatientCareTaskRequest, PatientCareTaskModel>();
        CreateMap<UpdatePatientCareTaskStatusRequest, PatientCareTaskModel>();
    }
}
